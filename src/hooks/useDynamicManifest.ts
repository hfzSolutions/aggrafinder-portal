...
import { updateManifestLink, resetToDefaultManifest as resetManifest } from '@/utils/clientManifest';
...
export const useDynamicManifest = (toolId: string, toolName?: string) => {
  ...
  const updateManifest = useCallback(async (currentToolId: string, currentToolName?: string) => {
    try {
