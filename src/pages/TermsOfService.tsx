...
const TermsOfService = () => {
  return (
    <>
      <Helmet>
        <title>Terms of Service | DeepList AI</title>
        <meta name="description" content="Terms of Service for DeepList AI" />
      </Helmet>
      <Header />
      <main className="flex-1 pt-16">
        <Container className="py-12">
          ...
          <div className="prose dark:prose-invert max-w-none">
            ...
            <p>
              By accessing or using DeepList AI's website, services, or
              applications (collectively, the "Services"), you agree to be bound
            ...
            <p>
              DeepList AI provides a platform for discovering, comparing, and
              reviewing AI tools and services. Our Services allow users to
              browse AI tools, read and submit reviews, and request new tools to
            ...
            <p>
              ...
              creating your account and to update your information to keep it
            ...
            <p>
              ...
              text, reviews, ratings, and images. You retain ownership of any
              intellectual property rights that you hold in that content.
            </p>
            <p>
              By submitting content to the Services, you grant DeepList AI a
            ...
            <p>
              ...
              users of the Services, us, or third parties, or for any other
              reason.
            </p>
