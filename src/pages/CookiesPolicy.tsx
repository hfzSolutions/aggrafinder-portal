...
const CookiesPolicy = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Cookies Policy | DeepList AI</title>
        <meta name="description" content="Cookies Policy for DeepList AI" />
      </Helmet>
      <Header />
      <main className="flex-1 pt-16">
        <Container className="py-12">
          ...
          <div className="prose dark:prose-invert max-w-none">
            ...
            <p>
              This Cookies Policy explains how DeepList AI ("we," "us," or
            ...
            <ul className="list-disc pl-5 my-4 space-y-2">
              <li>
                ...
                for the Services to function properly and cannot be switched off
                in our systems.
              </li>
              <li>
              ...
              <li>
                ...
                Services to provide enhanced functionality and personalization.
              </li>
              <li>
                <strong>Targeting Cookies:</strong> These cookies may be set
                through our Services by our advertising partners to build a
            ...
            <p>
              First-party cookies are cookies that are set by our website
              directly. We use first-party cookies to adapt our Services to your
              preferences and to improve your user experience.
            </p>
            ...
            <p>
              Third-party cookies are cookies that are set by domains other than
              our website. We may allow third parties, such as analytics
              services and advertising networks, to set cookies on our Services.
            </p>
