...
const RequestTool = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Simple validation
    if (!formData.name || !formData.description || !formData.url || formData.category.length === 0) {
      toast({
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Submit a request for a new AI tool to be added to our directory." />
      </Helmet>
        ...
        <main className="flex-grow pt-20 pb-20">
          <div className="container px-4 md:px-8 py-8 mx-auto">
            <div className="max-w-3xl mx-auto">
              <h1 className="text-3xl font-bold mb-6 text-center">Request a New AI Tool</h1>
              <p className="text-muted-foreground mb-8 text-center">
                Know an awesome AI tool that's not in our collection? Submit it here and we'll review it.
              </p>
                ...
                <CardContent>
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        >
                          ...
                          <SelectContent>
                            {pricingOptions.filter(option => option !== "All").map((option) => (
                    ...
                    <div className="border-t pt-6">
                      <CardTitle className="text-lg mb-4">About You (Optional)</CardTitle>
                      <div className="space-y-4">
                        <div>
